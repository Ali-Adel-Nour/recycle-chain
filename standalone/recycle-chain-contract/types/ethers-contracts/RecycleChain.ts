...
decodeFunctionResult(functionFragment: 'sellProductItems', data: BytesLike): Result;
    ...
    export namespace ManufacturerRegisteredEvent {
      export type InputTuple = [manufacturer: AddressLike, name: string, location: string, contact: string];
      export type OutputTuple = [manufacturer: string, name: string, location: string, contact: string];
      export interface OutputObject {manufacturer: string, name: string, location: string, contact: string };
    ...
    export namespace ProductCreatedEvent {
      export type InputTuple = [productId: BigNumberish, name: string, manufacturer: AddressLike];
      export type OutputTuple = [productId: bigint, name: string, manufacturer: string];
      export interface OutputObject {productId: bigint, name: string, manufacturer: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ProductItemsStateChangedEvent {
      export type InputTuple = [itemIds: string[], newState: BigNumberish];
      export type OutputTuple = [itemIds: string[], newState: bigint];
      export interface OutputObject {itemIds: string[], newState: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ToxicItemCreatedEvent {
      export type InputTuple = [productId: BigNumberish, name: string, weight: BigNumberish];
      export type OutputTuple = [productId: bigint, name: string, weight: bigint];
      export interface OutputObject {productId: bigint, name: string, weight: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    addProduct: TypedContractMethod<
      [_name: string, _toxicNames: string[], _toxicWeights: BigNumberish[], ],
      [void],
      'nonpayable'
    >
    ...
    manufacturers: TypedContractMethod<
      [arg0: AddressLike, ],
      [[string, string, string] & {name: string, location: string, contact: string }],
      'view'
    >
    ...
    productCounter: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    productItems: TypedContractMethod<
      [arg0: string, ],
      [[string, bigint, bigint] & {id: string, productId: bigint, state: bigint }],
      'view'
    >
...
getFunction(nameOrSignature: 'owner'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'productCounter'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'registerManufacturer'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'returnProductItems'): TypedContractMethod<
      [_itemIds: string[], ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'sellProductItems'): TypedContractMethod<
      [_itemIds: string[], ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'ProductItemAdded'): TypedContractEvent<ProductItemAddedEvent.InputTuple, ProductItemAddedEvent.OutputTuple, ProductItemAddedEvent.OutputObject>;
getEvent(key: 'ProductItemsStateChanged'): TypedContractEvent<ProductItemsStateChangedEvent.InputTuple, ProductItemsStateChangedEvent.OutputTuple, ProductItemsStateChangedEvent.OutputObject>;
getEvent(key: 'ToxicItemCreated'): TypedContractEvent<ToxicItemCreatedEvent.InputTuple, ToxicItemCreatedEvent.OutputTuple, ToxicItemCreatedEvent.OutputObject>;
    ...
    filters: {
      ...
      'ProductItemAdded(string[],uint256)': TypedContractEvent<ProductItemAddedEvent.InputTuple, ProductItemAddedEvent.OutputTuple, ProductItemAddedEvent.OutputObject>;
      ProductItemAdded: TypedContractEvent<ProductItemAddedEvent.InputTuple, ProductItemAddedEvent.OutputTuple, ProductItemAddedEvent.OutputObject>;
    

      'ProductItemsStateChanged(string[],uint8)': TypedContractEvent<ProductItemsStateChangedEvent.InputTuple, ProductItemsStateChangedEvent.OutputTuple, ProductItemsStateChangedEvent.OutputObject>;
      ProductItemsStateChanged: TypedContractEvent<ProductItemsStateChangedEvent.InputTuple, ProductItemsStateChangedEvent.OutputTuple, ProductItemsStateChangedEvent.OutputObject>;
